      ...
      <SheetContent className="flex w-full flex-col pr-0 sm:max-w-lg">
        ...
        {itemCount > 0 ? (
            ...
            <div className="space-y-4 pr-6">
              ...
              <SheetFooter>
                <SheetTrigger asChild>
                  <Link href={Paths.CART} className={buttonVariants({
                    className: 'w-full'
                  })}>
          ...
          <div className="flex h-full flex-col items-center justify-center space-y-1">
            <div aria-hidden className="relative mb-4 w-60 h-60 text-muted-foreground">
              <Image src={'/hippo-empty-cart.png'} alt='empty shopping cart hippo' fill/>
            </div>
            <div className="text-xl font-semibold"> Yor cart is empty</div>
            <SheetTrigger asChild>
              <Link href={Paths.PRODUCTS} className={buttonVariants({
                variant: 'link',
                size: 'sm',
